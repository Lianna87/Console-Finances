...
for (let i = 0; i < finances.length; i++) {
  ...
  totalDeposits = totalDeposits + monthlyTotal
  if (i > 0) {
    difference = monthlyTotal - previousAmount
  }
    previousAmount = monthlyTotal
...
Total: ${totalDeposits}
Average Change: ${averageDeposit}
Greatest Increase in Profits/Losses: ${greatestChange} 
Greatest Decrease in Profits/Losses: ${leastChange}`)